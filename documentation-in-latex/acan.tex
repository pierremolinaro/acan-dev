...
\setsansfont{Courier}[Ligatures=NoCommon,Scale=0.9]
\setmonofont{Courier}[Ligatures=NoCommon,Scale=0.9]
...
\title{\bf \Huge{ACAN library\\for Teensy 3.1 / 3.2, 3.5, 3.6\\Version 2.0.3}}
